...
You can also customize the worktree location using the `worktreeBaseDirectory` configuration option in `phantom.config.json`. This allows you to store worktrees in any location you prefer.
