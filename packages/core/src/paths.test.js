...
describe("paths", () => {
  describe("getWorktreesDirectory", () => {
    it("should return correct phantom directory path", () => {
      ...
      strictEqual(result, normalize("/test/repo/.git/phantom/worktrees"));
    });
