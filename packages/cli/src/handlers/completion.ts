...
import { BASH_COMPLETION_SCRIPT } from "../completions/phantom-bash.ts";
import { FISH_COMPLETION_SCRIPT } from "../completions/phantom-fish.ts";
import { ZSH_COMPLETION_SCRIPT } from "../completions/phantom-zsh.ts";
